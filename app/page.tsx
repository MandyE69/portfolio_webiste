          ...
          <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-center gap-12">
            ...
            <div className="md:order-2 order-2 md:text-left text-center flex-1">
              ...
              <p className="text-muted-foreground mb-8">
                ...
                in web development, artificial intelligence, and cloud
                technologies. I love building innovative solutions that solve
                real-world problems and am constantly exploring new technologies
                to expand my skill set. Currently pursuing my CSIT degree while
                working on exciting projects and contributing to the tech
                community.
              </p>
              ...
              <div className="flex gap-4 mt-6 md:justify-start justify-center">
                ...
                <Link
                  href="https://www.facebook.com/mandip.gyawali.2025/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                ...
                <Link
                  href="https://www.instagram.com/mah.madhavv/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                Hello! I'm Madhav Gyawali, a passionate Computer Science and
                Information Technology student with a deep enthusiasm for
                technology and innovation.
              </p>
              <p className="text-muted-foreground mb-4">
                I'm constantly exploring new technologies and frameworks, with a
                particular interest in web development, artificial intelligence,
                and cloud computing.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Technologies I work with regularly and have strong expertise
                  in.
                </p>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground mb-4">
                  Technologies I've used in multiple projects with good
                  understanding.
                </p>
                <div className="flex flex-wrap gap-2">
                  <Badge>Node.js</Badge>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="overflow-hidden">
              ...
              <CardContent className="p-6">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex gap-2">
                    <Button variant="ghost" size="icon" asChild>
                      <Link
                        href="https://github.com/MandyE69/ShopWise-_product_recommendation_system"
                ...
                <p className="text-muted-foreground mb-4">
                  ShopWise is a machine learning-based product recommendation
                  system designed to enhance the shopping experience by
                  suggesting relevant products based on user input. It leverages
                  content-based filtering techniques to provide personalized
                  recommendations.
                </p>
                <div className="flex flex-wrap gap-2">
              ...
              <CardContent className="p-6">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex gap-2">
                    <Button variant="ghost" size="icon" asChild>
                      <Link
                        href="https://github.com/MandyE69/Superhero_website"
                        aria-label="View code"
                      >
                        <Github className="h-4 w-4" />
                      </Link>
                    ...
                    <Button variant="ghost" size="icon" asChild>
                      <Link
                        href="https://mandye69.github.io/Superhero_website/"
              ...
              <CardContent className="p-6">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex gap-2">
                    <Button variant="ghost" size="icon" asChild>
                      <Link
                        href="https://github.com/MandyE69/MadhavGyawali"
                        aria-label="View code"
                      >
                        <Github className="h-4 w-4" />
                      </Link>
                    ...
                    <Button variant="ghost" size="icon" asChild>
                      <Link
                        href="https://madhavgyawali9.com.np"
                        aria-label="View live demo"
                      >
                        <ExternalLink className="h-4 w-4" />
                      </Link>
            ...
            <Card className="overflow-hidden">
              ...
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">E-Pustakalaya is a CRUD based prioject for practicing Node.js</p>
                <div className="flex flex-wrap gap-2">
                  <Badge variant="outline">Node.js</Badge>
                  <Badge variant="outline">Supabase</Badge>
                  <Badge variant="outline">Express</Badge>
                  <Badge variant="outline">Sequilize</Badge>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="relative border-l border-muted pl-8 pb-10">
              ...
              <p className="mt-4">
                ...
                development, and information systems. Maintaining a strong
                academic record while participating in various tech clubs and
                events.
              </p>
            </div>
            <div className="relative border-l border-muted pl-8 pb-10">
            ...
            <div className="relative border-l border-muted pl-8">
              ...
              <div className="mb-2">
                ...
                <h3 className="text-xl font-semibold">
                  Secondary Level +2 Computer Science
                </h3>
                <p className="text-muted-foreground">
              ...
              <p className="mt-4">
                ...
                Participated in various tech workshops that sparked my interest
                in computer science.
              </p>
            </div>
          </div>
              ...
              <CardContent className="pt-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <a
                      href="mailto:madhavgyawali436@gmail.com"
